...
stop_loss_range=(None 5 9 10 11 12.5 14 15 17 20 22 24 26 28 30 32 34 36 38 40 42 44 46 48 50 52 55 60)
    ...
    for s in "${!stop_loss_range[@]}"; do
        for t in "${!take_profit_range[@]}"; do
            ...
            python src/main.py -s ${strategies} -e ${exchanges} -m ${markets} \
                ...
                -mp "stop_loss ${stop_loss} take_profit ${take_profit}" > /dev/null 2>&1;
        done
    done
